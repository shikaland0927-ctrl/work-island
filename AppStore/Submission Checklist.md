...
- [x] Version 1.0.0 configured; local source now targets build 57, while uploaded build 1 remains unchanged
...
- [x] Swift package tests pass: 107/107 on the current 0.11.21 source
...
- [x] Create and structurally validate an unsigned universal version 1.0.0, build 57 archive from the current source
- [ ] Create and validate a Distribution-signed version 1.0.0, build 57 or a newer unique build from the current source
