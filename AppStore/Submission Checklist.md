...
- [x] Version 1.0.0 configured; local source now targets build 59, while uploaded build 1 remains unchanged
...
- [x] Swift package tests pass: 109/109 on the current 0.11.23 source
...
- [x] Re-run all tests on the current source: 109/109 passed on 2026-08-14
...
- [x] Create and structurally validate an unsigned universal version 1.0.0, build 59 archive from the current source
- [ ] Create and validate a Distribution-signed version 1.0.0, build 59 or a newer unique build from the current source
