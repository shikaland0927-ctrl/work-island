...
- [x] Version 1.0.0 configured; local source now targets build 74, while uploaded build 1 remains unchanged
...
- [x] Swift package tests pass: 118/118 on the current 0.11.38 source
...
- [x] Re-run all tests on the current source: 118/118 passed on 2026-08-16
...
- [x] Create and structurally validate an unsigned universal version 1.0.0, build 74 archive from the current source
- [ ] Create and validate a Distribution-signed version 1.0.0, build 74 or a newer unique build from the current source
