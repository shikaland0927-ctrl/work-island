...
- [x] Version 1.0.0 configured; local source now targets build 75, while uploaded build 1 remains unchanged
...
- [x] Swift package tests pass: 119/119 on the current 0.11.39 source
...
- [x] Re-run all tests on the current source: 119/119 passed on 2026-08-18
...
- [x] Create and structurally validate an unsigned universal version 1.0.0, build 75 archive from the current source
- [ ] Create and validate a Distribution-signed version 1.0.0, build 75 or a newer unique build from the current source
