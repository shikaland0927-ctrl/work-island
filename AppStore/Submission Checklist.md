...
- [x] Version 1.0.0 configured; local source now targets build 55, while uploaded build 1 remains unchanged
...
- [x] Swift package tests pass: 99/99 on the current 0.11.19 source
...
- [x] Re-run all tests on the current source: 99/99 passed on 2026-08-13
...
- [x] Create and structurally validate an unsigned universal version 1.0.0, build 55 archive from the current source
- [ ] Create and validate a Distribution-signed version 1.0.0, build 55 or a newer unique build from the current source
