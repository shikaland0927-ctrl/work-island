...
The app root is now a Git repository with `main` as its default branch. Its private source remote is `https://github.com/shikaland0927-ctrl/work-island-app`; this is intentionally separate from the public `work-island` support/privacy Pages repository. Build products, QA data, real-data backups, archives, signing material, credentials, and environment files are excluded from tracking.
